...
def cont_cpu_stats(cont_list, hypUser, hypIP):
        ...
        os.system("scp cont_stats.py "+ hypUser+"@"+hypIP+":/home/ece792/")
        output =subprocess.check_output('ssh' + ' ' + hypUser + '@' + hypIP + ' ' + 'sudo python -W ignore  /home/ece792/cont_stats.py '+list_,shell =True)
...
def scalingdecision(con_dict, max, min, status, scaleuptime, cooldownperiod, hypIP):
	...
	cpu_percent = getcpustats_hyp("192.168.50.80", "root")
